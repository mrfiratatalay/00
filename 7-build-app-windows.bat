...
call reportgenerator "-title:pomodoro Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:pomodoro Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for pomodoro
call OpenCppCoverage.exe --export_type=binary:pomodoro_tests_unit_win.cov --sources src\pomodoro\src --sources src\pomodoro\header --sources src\tests\pomodoro -- build_win\build\Debug\pomodoro_tests.exe

echo Generate Test Coverage Data for pomodoro App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=pomodoro_tests_unit_win.cov --export_type=cobertura:pomodoroapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\pomodoro\src --sources src\pomodoro\header --sources src\pomodoroapp\src --sources src\pomodoroapp\header --sources src\tests\utility --sources src\tests\pomodoro -- build_win\build\Debug\pomodoroapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:pomodoro Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/pomodoroapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/pomodoro/src;src/pomodoro/header;src/pomodoroapp/src;src/pomodoroapp/header;src/tests/utility;src/tests/pomodoro" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/pomodoroapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/pomodoro/src;src/pomodoro/header;src/pomodoroapp/src;src/pomodoroapp/header;src/tests/utility;src/tests/pomodoro" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\pomodoro\header "build_win\build\Release" /E
call robocopy src\pomodoroapp\header "build_win\build\Release" /E
...
call robocopy src\pomodoro\header "build_win\build\Debug" /E
call robocopy src\pomodoroapp\header "build_win\build\Debug" /E
